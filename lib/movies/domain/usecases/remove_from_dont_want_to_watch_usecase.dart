...
class RemoveFromDontWantToWatchUsecase {
  final UserMoviesRepository _userMoviesRepository;
  const RemoveFromDontWantToWatchUsecase(this._userMoviesRepository);

  Future<Either<Failure, Unit>> call(Movie movie) async {
    return await _userMoviesRepository.removeFromDontWantToWatch(movie);
  }
}
