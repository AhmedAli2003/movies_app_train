...
class AddToDontWantToWatchUsecase {
  final UserMoviesRepository _userMoviesRepository;
  const AddToDontWantToWatchUsecase(this._userMoviesRepository);

  Future<Either<Failure, Unit>> call(Movie movie) async {
    return await _userMoviesRepository.addToDontWantToWatch(movie);
  }
}
