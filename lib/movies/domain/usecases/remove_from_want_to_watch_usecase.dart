...
class RemoveFromWantToWatchUsecase {
  final UserMoviesRepository _userMoviesRepository;
  const RemoveFromWantToWatchUsecase(this._userMoviesRepository);

  Future<Either<Failure, Unit>> call(Movie movie) async {
    return await _userMoviesRepository.removeFromWantToWatch(movie);
  }
}
